...
class QLayer(Layer):
    def __init__(self, set_fixed = 0, set_trans = 0, set_att = 8, dense_dim = 32, concept_dim = 32, num_concept = 128, trans_layers = 1, batch_size = 8, distribute_size = 64, regularizer = 0.0005, direct_pass = False):
        ...
        self.direct_pass = direct_pass # Not used
        self.pass_ratio = 0.2
